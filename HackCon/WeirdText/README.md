...
This mysterious file just has some weird combo of characters "ooooh spooooky"...

```
...+[>+>+++>+++++++>++++++++++<<<<-]>>>--.<+++++++++.>>----.<...
```

but I did notice that not all the characters in the list of "><+-.,[]" show up in the line of characters.

This likely means its a special esolang that only uses these characters, some of whcih just did not happen to be in this program.
Putting it through the brainfuck interpreter [here](https://copy.sh/brainfuck/) returns this string of charcaters
...
Whiel that may not be readable, it is another esolang! This time its malbolge and [this](http://www.malbolge.doleczek.pl/) solves it to a different set of unreadable characters!
...
But this time [this](https://www.rapidtables.com/convert/number/hex-to-ascii.html) simple hex to ASCII translator is able to solve it to a long string of letters.
...

	±·*
	 V);gnirtS/gnal/avajL(nltnirpmaertStnirP/oi/avaj;maertStnirP/oi/avajLtuometsyS/gnal/avajnoitpecxE/gnal/avajtcejbO/gnal/avajneg_galf! ed0c}t53b_5t1_t@_3b@b_3f@c_ht1w_3gAugnAl_c1r3t05e{kr4d6	avaj.neg_galf
eliFecruoS
snoitpecxE
...
And something very specific pops out, is that d4rk backwards I see right here?

```
ed0c}t53b_5t1_t@_3b@b_3f@c_ht1w_3gAugnAl_c1r3t05e{kr4d
```

Now putting this through one last interpreter (reverse a string) [here](https://www.browserling.com/tools/text-reverse) finally retruns the solution, a flag!
